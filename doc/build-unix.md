UNIX BUILD NOTES
====================
Some notes on how to build Tidecoin in Unix.
...
memory available when compiling Tidecoin. On systems with less, gcc can be
...
To build Tidecoin without the wallet, see [*Disable-wallet mode*](#disable-wallet-mode)
...
Disable-wallet mode
--------------------
When the intention is to only run a P2P node, without a wallet, Tidecoin can
