...
RPCHelpMan lockunspent()
{
    return RPCHelpMan{
        ...
        "Updates list of temporarily unspendable outputs.\n"
                ...
                "A locked transaction output will not be chosen by automatic coin selection, when spending Tidecoin.\n"
    ...
    return RPCHelpMan{
        ...
        "Returns array of unspent transaction outputs\n"
                ...
                "Optionally filter to only include txouts paid to specified addresses.\n",
                {
                    ...
                    {"addresses", RPCArg::Type::ARR, RPCArg::Default{UniValue::VARR}, "The Tidecoin addresses to filter",
                        {
                ...
                RPCResult{
                    RPCResult::Type::ARR, "", "",
                    {
                        {RPCResult::Type::OBJ, "", "",
                        {
                            ...
                            {RPCResult::Type::NUM, "vout", "the vout value"},
                            {RPCResult::Type::STR, "address", /*optional=*/true, "the Tidecoin address"},
