...
namespace init {
namespace {
const char* EXE_NAME = "tidecoin-gui";
...
public:
    ...
    // tidecoin-gui accepts -ipcbind option even though it does not use it
    // directly. It just returns true here to accept the option because
    // tidecoin-node accepts the option, and tidecoin-gui accepts all tidecoin-node
