...
#define QAPP_ORG_NAME "Tidecoin"
#define QAPP_ORG_DOMAIN "tidecoin.org"
#define QAPP_APP_NAME_DEFAULT "Tidecoin-Qt"
#define QAPP_APP_NAME_TESTNET "Tidecoin-Qt-testnet"
#define QAPP_APP_NAME_REGTEST "Tidecoin-Qt-regtest"
