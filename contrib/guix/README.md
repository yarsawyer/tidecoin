# Bootstrappable Tidecoin Builds

This directory contains the files necessary to perform bootstrappable Tidecoin
builds.
...
To build Tidecoin reproducibly with all default options, invoke the
...
```
env DETACHED_SIGS_REPO=<path/to/tidecoin-detached-sigs> ./contrib/guix/guix-codesign
```
...
repository, Guix build outputs are attested to in a project-maintained
