...
# Extract options
function __fish_tidecoin_tx_get_options
...
# Extract commands
function __fish_tidecoin_tx_get_commands
...
complete \
    --command tidecoin-tx \
    --condition "not __fish_tidecoin_seen_cmd (__fish_tidecoin_tx_get_commands --commandsonly)" \
    --arguments "(__fish_tidecoin_tx_get_options)" \
    --no-files

# Add commands
complete \
    --command tidecoin-tx \
    --arguments "(__fish_tidecoin_tx_get_commands)" \
    --no-files
