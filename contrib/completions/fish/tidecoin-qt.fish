...
complete --command tidecoin-qt --no-files

# Extract options
function __fish_tidecoinqt_get_options
...
complete \
    --command tidecoin-qt \
    --arguments "(__fish_tidecoinqt_get_options --nofiles)"
