...
complete --command tidecoind --no-files

# Extract options
function __fish_tidecoind_get_options
...
complete \
    --command tidecoind \
    --arguments "(__fish_tidecoind_get_options --nofiles)"
